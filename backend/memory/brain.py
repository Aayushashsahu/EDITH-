...
class SecondBrain:
    ...
    async def _embed_all(self, texts: list) -> list:
        # Performance: avoid sequential list comprehensions for I/O bound LLM calls
        # Use asyncio.gather with a batch size of 5 to balance speed and local system load
        batch_size = 5
        results = []
