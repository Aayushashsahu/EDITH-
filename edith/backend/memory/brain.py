...
class SecondBrain:
    ...
    async def _embed_all(self, texts: list) -> list:
        # Use asyncio.gather with a batch size of 5 to run embedding generation
        # concurrently. This optimizes performance compared to a sequential loop,
        # without overloading the local Ollama instance with too many requests at once.
        results = []
        batch_size = 5
