...
class SecondBrain:
    ...
    async def _embed_all(self, texts: list) -> list:
        # ⚡ Bolt Optimization: Replace sequential list comprehension with batched concurrent execution
        # Impact: Significantly reduces latency for embedding multiple chunks by executing concurrently.
        # Using a batch size of 5 avoids overloading the local LLM while improving performance.
        batch_size = 5
        results = []
